...
const TypeWriter = () => {
  ...
  return (
    <div className='absolute left-10 top-1/2 transform -translate-y-1/2 text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] xl:text-[4rem] font-bold text-white' style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
      <p>Hi there, I am</p>
