  ...
  return (
    <div>
      <div className='flex flex-col items-center'>
        ...
        <div className='w-4/5'>
            <p>I'm currently a junior at FIU working under the supervision of Professor Janki Bhimani in the <Link className='text-blue-600 underline' href={'https://damrl.cis.fiu.edu/'} target='_blank'>DaMRL Lab</Link>. My research interests include <b>Machine Learning</b>, <b>Computer Systems</b>, and <b>Practical AI</b>.</p>
