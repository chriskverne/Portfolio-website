  ...
  return (
    <div className='flex flex-col items-center mb-5'>
      ...
      <div className='w-4/5'>
        ...
        <p className='mt-2'>With the explosion of large language models, many companies use thousands of GPU&apos;s and months of training time to develop 1 single model. My goal is to reduce the computational power needed for this by developing more efficient deep learning architectures and optimizing processes such as parallel computing.</p>
