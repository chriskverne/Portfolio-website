    ...
    <div>
      <div className='flex flex-col items-center'>
        ...
        <div className='w-4/5'>
            ...
            <p className='mt-2'>My work dives into optimizing storage systems such as SSD's and RAM, optimizing ML phases such as ML training, and exploring use cases of AI in computer storage systems and other fields. After my bachelors, I will continue to pursue AI related research in Grad school.</p>
